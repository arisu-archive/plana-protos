...
type HexaUnit struct {
	...
	HpInfos                                   *mapx.OrderedMap[int64, int64]         `json:",omitempty,omitzero"`
	DyingInfos                                *mapx.OrderedMap[int64, int64]         `json:",omitempty,omitzero"`
	BuffInfos                                 *mapx.OrderedMap[int64, int32]         `json:",omitempty,omitzero"`
	...
	RewardParcelInfosWithDropTacticEntityType *mapx.OrderedMap[string, []ParcelInfo] `json:",omitempty,omitzero"`
