...
const (
	...
	OpenConditionLockReason_EventStageClear         OpenConditionLockReason = 128
	OpenConditionLockReason_EventScenarioModeClear  OpenConditionLockReason = 256
	OpenConditionLockReason_EventScenarioGroupClear OpenConditionLockReason = 512
)
