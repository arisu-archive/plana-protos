...
type CurrencyValue struct {
	Values                    *mapx.OrderedMap[string, int64] `json:",omitempty,omitzero"`
	Tickets                   *mapx.OrderedMap[string, int64] `json:",omitempty,omitzero"`
	Property                  *mapx.OrderedMap[string, int64] `json:",omitempty,omitzero"`
