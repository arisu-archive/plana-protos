...
type CurrencyValue struct {
	Values map[flatdata.CurrencyTypes]int64 `json:",omitempty,omitzero"`
	Tickets map[flatdata.CurrencyTypes]int64 `json:",omitempty,omitzero"`
	Property map[flatdata.CurrencyTypes]int64 `json:",omitempty,omitzero"`
