...
- Protocol and web API error enums with string and JSON helpers.
...
Maintainers can run the same conversion locally with Bash, `curl`, `unzip`, Go, and `golangci-lint` installed:
